...
char * job_name(int class_)
{
	...
	case JOB_ROYAL_GUARD2: return "Royal Guard Peco";
	case JOB_ROYAL_GUARD_T2: return "Royal Guard Peco";
	case JOB_RANGER2: return "Ranger Wolf";
	case JOB_RANGER_T2: return "Ranger Wolf";
	}
	return "Unknown Job";
}
