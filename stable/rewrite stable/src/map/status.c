...
void initChangeTables(void)
{
	...
	set_sc( WM_SATURDAY_NIGHT_FEVER, SC_SATURDAYNIGHTFEVER       , SI_SATURDAYNIGHTFEVER           , SCB_DEF|SCB_DEF2|SCB_MDEF|SCB_MDEF2|SCB_FLEE|SCB_SPEED|SCB_ASPD|SCB_MAXHP|SCB_REGEN );
