...
// 297 to 329. Lets reserve this for future eA SC addon.
/*SIDE NOTE: 
		It might be cleaner if we add new SC under the last SC declared (above SC_MAX).
		Also don't forget to add it in the const.txt thats how eA added new SC. [Jobbie]*/

/* As of right now, SCs will have a range for each class. For example, Rune Knight SCs are from 350 to 380. RK-related
	SCs are to be added only on that range, below the last-added SC. This will make things more organized and it won't
	be needed to re-structure the entire const.txt file. Also, watch out for shared SCs, like Freezing and Burning,
	they have their own range. [LimitLine]*/
...
// 329
	SI_ORATIO = 330,
// 331-332
	SI_POISONSMOKECLOAKINGEXCEED = 333,	// For whatever reason they share the same SI. [LimitLine]
...
// 400
	...
	SI_PRESTIGE = 402,
	SI_INVISIBILITY = 403,
	SI_DIMENSIONDOOR = 404, // Is it really Dimension Door? [LimitLine]
	SI_BANDING = 405,
	// 406
	SI_INSPIRATION = 407,
...
// 417-420
	...
	SI_MANHOLE = 422,
// 423-424
	SI_GT_ENERGYGAIN = 425,
	SI_GT_CHANGE = 426,
	SI_GT_REVITALIZE = 427,
// 428
	SI_SWINGDANCE = 429,
	SI_SYMPHONY = 430,
// 431-434
...
// 445-446
	...
	SI_MINWAND, // Need to figure out what it is. [LimitLine]
// 449
	SI_ANALYZE = 450,
	SI_LERADSDEW = 451,
	SI_MELODYOFSINK = 452,
...
enum {
	...
	OPTION_MADO         = 0x00400000, //Male and Female Mado Option. [Jobbie]
...
struct status_change {
	...
	int stealth_id;	//ID of the last Stealth Field you were on. [LimitLine]
	int magicdecoy_x, magicdecoy_y; //X and Y coordinates for Magic Decoy. [LimitLine]
	short fatal_x, fatal_y;	//X and Y destination of Fatal Menace. [LimitLine]
