...
//The number is the max number of hotkeys to save (27 = 9 skills x 3 bars)					(0x02b9,191)
//The number is the max number of hotkeys to save (36 = 9 skills x 4 bars)					(0x07d9,254)
//The number is the max number of hotkeys to save (38 = 9 skills x 4 bars & 2 Quickslots)	(0x07d9,268)
#define MAX_HOTKEYS ((PACKETVER < 20090603)?27:((PACKETVER < 20090617)?36:38))
